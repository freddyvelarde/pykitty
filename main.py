...
from src.config.colorschemes import nvim_colorschemes, kitty_colorschemes
...
def main():
    ...
    if args.vim:
        if args.vim_theme in nvim_colorschemes:
            switcher(vim_dir, nvim_colorschemes[args.vim_theme])
